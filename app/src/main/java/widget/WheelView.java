...
import com.yrtech.datepickerpopupwindow.R;
...
public class WheelView extends View {
    ...
    private void initResourcesIfNecessary() {
        ...
        if (centerDrawable == null) {
            centerDrawable = new ColorDrawable(Color.argb(0, 0, 0, 0));
        }
    ...
    public String getCurrentItemValue() {
        return ((StrericWheelAdapter) getAdapter()).getStrContents().get(getCurrentItem());
    }
